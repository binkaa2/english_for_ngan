        ...
        <div class="row" style="padding: 10px">
           <div class="col-12">
            <div class="card">
                    ...
                    <div class="card-body">
                        <div><h4>Solution for: Global Warming in New Zealand</h4></div>
                        <div>
...
However, New Zealand’s effort counts only a tip of the iceberg. So far, global warming has been a world issue that still hangs in an ambiguous future.
                        ...
                        <div class="pt-5" style="margin-bottom: 0;
                            ...
                            <h1>STEP 2 - Answer these questions (choose the best answer):</h1>
                        </div>
                        <div class="pt-3">
                            <h2>
                            Questions 1-6
                        ...
                        <div class="pt-5">
                            ...
                            <p> In boxes 10-14 on your answer sheet write</p>
                            <p> <strong>YES</strong> if the statement agree with the claims of the writer</p>
                        ...
                        <div class="pt-4 pb-5">
                                <strong>10.</strong> Farmers are less responsive to climate change than agriculturists.
                        </div>
                        ...
                        <div class="pt-2 pb-5">
                                <strong>11.</strong> Agricultural sector is too conservative and resistant to deal with climate change.
                        </div>
                        <div class="d-flex" style="justify-content:space-around">
                            <div class="custom-control custom-radio">
                        ...
                        <div class="pt-2 pb-5">
                                <strong>12.</strong> Turtle is vulnerable to climate change.
                        </div>
                        <div class="d-flex" style="justify-content:space-around">
                            <div class="custom-control custom-radio">
                        ...
                        <div class="pt-2 pb-5">
                                <strong>13.</strong> The global warming is going slowly, and it may have different effects on different areas in New Zealand.
                        </div>
                        <div class="d-flex" style="justify-content:space-around">
                            <div class="custom-control custom-radio">
                        ...
                        <div class="pt-2 pb-5">
                                <strong>14.</strong> New Zealand must cut carbon dioxide emission if they want to solve the problem of global warming.
                        </div>
                        <div class="d-flex" style="justify-content:space-around">
                            <div class="custom-control custom-radio">
                        ...
                        <div class="row pt-4 pb-2">
                            ...
                            <div class="col-4">
                                <div class="d-flex" style="justify-content: space-around;">
                                <a class="btn btn-icon btn-primary" href="{{route('unit1.reading.text1')}}" type="button">
