            ...
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pt-2">
                            ...
                            <input type="radio" name="cau1" value="a">  <strong>A</strong> Egypt was planning to build a dam that would harm ancient temples.<br>
                            <input type="radio" name="cau1" value="b">  <strong>B</strong> Egypt was planning to build a valley for agriculture and electricity.<br>
                            <input type="radio" name="cau1" value="c">  <strong>C</strong> Egypt was planning to create a dam right on top of an ancient temple.<br>
                            <input type="radio" name="cau1" value="d">  <strong>D</strong> When the dam flooded a valley, several treasures were discovered.
                        </div>

                        <div class="pt-2">
                            <h4>2. What is meant by the first sentence of the second paragraph?</h4>
                            <input type="radio" name="cau1" value="a">  <strong>A</strong> Most governments prefer to sell their treasures.<br>
                            <input type="radio" name="cau1" value="b">  <strong>B</strong> Money sometimes seems more important than all other things.<br>
                            <input type="radio" name="cau1" value="c">  <strong>C</strong> Governments are never able to consider two things at once.<br>
                            <input type="radio" name="cau1" value="d">  <strong>D</strong> Governments usually don't know anything about their culture.
                        </div>

                        <div class="pt-2">
                            <h4>3. The United Nations would probably not be involved in <strong>_____</strong></h4>
                            <input type="radio" name="cau1" value="a">  <strong>A</strong> helping a poor country improve its agriculture.<br>
                            <input type="radio" name="cau1" value="b">  <strong>B</strong> trying to solve a violent conflict between two nations.<br>
                            <input type="radio" name="cau1" value="c">  <strong>C</strong> developing a new spacecraft for travel to the moon.<br>
                            <input type="radio" name="cau1" value="d">  <strong>D</strong> protesting against the killing of the tribes people of a country.
                        </div>

                        <div class="pt-2">
                            <h4>4. Why is the World Heritage Organization more important now than it would have been 200 years ago?</h4>
                            <input type="radio" name="cau1" value="a">  <strong>A</strong> Countries didn't cooperate in the past.<br>
                            <input type="radio" name="cau1" value="b">  <strong>B</strong> Cities were smaller back then.<br>
                            <input type="radio" name="cau1" value="c">  <strong>C</strong> There were not as many interesting sites 200 years ago.<br>
                            <input type="radio" name="cau1" value="d">  <strong>D</strong> Modern business and production are changing the world.
                        </div>
