...
@section('content')
<!-- Page content -->
<form method="post" enctype="multipart/form-data" action="{{route('banners.update',$banner->_id)}}">
    @method('PUT')
    @csrf
                    ...
                    <div class="card-body">
                        <div class="pl-lg-4">
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="basic-usage form-control input-3km" name="name"
                                            required value="{{$banner->name}}" />
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="basic-usage form-control input-3km" name="url"
                                            required value="@isset($banner->link) {{$banner->link}} @endif" />
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input required class="form-control" name="sequence" type="number"
                                            value="{{$banner->sequence}}" id="example-number-input">
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" accept="image/*" id="image"
                                                name="image" lang="en">
                                            <input type="text" id="base64" hidden value="{{$banner->image_url}}"
                                                name="base64" />
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div id="divImageMediaPreview" class="text-center">
